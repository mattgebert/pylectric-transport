...
for obj in file_data_objs:
    ...
    for i in range(len(datasets)):
        ...
        meas_obj = Meas_GatedResistance(data=datasets[i], Cg=SiO2_Cg, L=L, W=W)
...
kwargs = {"s":0.1}
ax = rvt_obj.plot_Rho_vT(c=c,**kwargs)
# ax.set_yscale("log")
...
# # vgs_exp = np.linspace(26,62,10) #6 voltages, 5-30 includive.
# fit_dirac_exp = fitted_dirac_points[t1:t2]
# temps_exp = temps[t1:t2]
# temps_exp
# exp_meas_objs = meas_objs[t1:t2]
