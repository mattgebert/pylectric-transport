...
# FILE_DESCRIPTOR1 = "hBN-Gr_Devs4_04_run04_V01-V02_RhoVG-Extraction_Exp 50.00K-225.00K 22.0V-58.0V.txt" # Bare Graphene
# FILE_DESCRIPTOR2 = "hBN-Gr_Devs4_04_run04_V03-V04_RhoVG-Extraction_Exp 50.00K-225.00K 22.0V-58.0V.txt" # Gallium Oxide [Bare]

# FILE_DESCRIPTOR1 = "hBN-Gr_Devs4_04_run04_V01-V02_RhoVG-Extraction_Exp 50.00K-225.00K 26.0V-58.0V.txt" # Bare Graphene
# FILE_DESCRIPTOR2 = "hBN-Gr_Devs4_04_run04_V03-V04_RhoVG-Extraction_Exp 50.00K-225.00K 26.0V-58.0V.txt" # Gallium Oxide [Bare]

FILE_DESCRIPTOR1 = "hBN-Gr_Devs4_04_run04_V01-V02_RhoVG-Extraction_Exp 50.00K-225.00K 30.0V-58.0V.txt" # Bare Graphene
FILE_DESCRIPTOR2 = "hBN-Gr_Devs4_04_run04_V03-V04_RhoVG-Extraction_Exp 50.00K-225.00K 30.0V-58.0V.txt" # Gallium Oxide [Bare]
...
## Plot the data:
plt.rcParams.update({'font.size': 3, "figure.figsize" : [2,4], 'figure.dpi':600})
...
param_rows = ["SiO$_2$/Gr: SiO$_2$ Fit",
    "SiO$_2$/Gr/Ga$_2$O$_3$: SiO$_2$ Fit"
    # "SiO$_2$/Gr/Ga$_2$O$_3$: Ga$_2$O$_3$ Fit"
    ]
param_list = []
...
exp_ax.set_title(r"Devs4_04 Run4; Bare graphene & Ga$_2$O$_3$ covered graphene"+"\n"+r"Prior to Ga$_2$O$_3$ deposition")
...
if os.path.exists(saveLoc + ".png"):
    i = 0
    while os.path.exists(saveLoc + str(i) + ".png"):
        i += 1
    saveTarget = saveLoc + str(i) + ".png"
else:
    saveTarget = saveLoc + ".png"
